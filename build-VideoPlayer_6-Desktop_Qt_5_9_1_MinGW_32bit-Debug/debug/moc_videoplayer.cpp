...
QT_MOC_LITERAL(1, 12, 20), // "slotTotalTimeChanged"
QT_MOC_LITERAL(2, 33, 0), // ""
QT_MOC_LITERAL(3, 34, 4), // "uSec"
QT_MOC_LITERAL(4, 39, 15), // "slotSliderMoved"
QT_MOC_LITERAL(5, 55, 5), // "value"
QT_MOC_LITERAL(6, 61, 16), // "slotTimerTimeOut"
QT_MOC_LITERAL(7, 78, 12), // "slotBtnClick"
QT_MOC_LITERAL(8, 91, 16), // "slotStateChanged"
QT_MOC_LITERAL(9, 108, 31), // "VideoPlayer_Thread::PlayerState"
QT_MOC_LITERAL(10, 140, 5) // "state"

    },
    "VideoPlayer\0slotTotalTimeChanged\0\0"
    "uSec\0slotSliderMoved\0value\0slotTimerTimeOut\0"
    "slotBtnClick\0slotStateChanged\0"
    "VideoPlayer_Thread::PlayerState\0state"
};
...
void VideoPlayer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->slotTotalTimeChanged((*reinterpret_cast< qint64(*)>(_a[1]))); break;
        case 1: _t->slotSliderMoved((*reinterpret_cast< int(*)>(_a[1]))); break;
        case 2: _t->slotTimerTimeOut(); break;
        case 3: _t->slotBtnClick(); break;
        case 4: _t->slotStateChanged((*reinterpret_cast< VideoPlayer_Thread::PlayerState(*)>(_a[1]))); break;
        default: ;
        }
    }
}
...
const QMetaObject VideoPlayer::staticMetaObject = {
    { &CustomTitle::staticMetaObject, qt_meta_stringdata_VideoPlayer.data,
...
void *VideoPlayer::qt_metacast(const char *_clname)
{
    ...
    return CustomTitle::qt_metacast(_clname);
}

int VideoPlayer::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    _id = CustomTitle::qt_metacall(_c, _id, _a);
    if (_id < 0)
        return _id;
    if (_c == QMetaObject::InvokeMetaMethod) {
        if (_id < 5)
